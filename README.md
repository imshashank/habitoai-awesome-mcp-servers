...
- [API.market MCP Gateway](https://api.market/api/mcp/gateway) - Hosted Streamable HTTP gateway for discovering and calling 580+ APIs through five tools, with OAuth or API-key authentication and per-API pricing.
